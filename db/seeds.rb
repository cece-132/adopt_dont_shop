...
pet_app4 = PetApplicant.create!(pet_id: pet3.id, applicant_id: app3.id)
pet_app4 = PetApplicant.create!(pet_id: pet4.id, applicant_id: app3.id)
pet_app4 = PetApplicant.create!(pet_id: pet4.id, applicant_id: app2.id)
